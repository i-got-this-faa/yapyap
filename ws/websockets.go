...
const (
	...
	// Channel-related events // prefix (2xxx) - SERVER TO CLIENT ONLY
	...
	// MESSAGE-related events // prefix (3xxx) - SERVER TO CLIENT ONLY
...
// A WebSocketEvent message sent over a WebSocket connection.
...
func (e WebSocketEvent) MarshalJSON() ([]byte, error) {
